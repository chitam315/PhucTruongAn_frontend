...
export default function PaymentPolicy() {
  return (
    ...
    >
      ...
      <p>
        <strong>1. Thanh toán khi nhận hàng</strong>
      </p>
      ...
      <p>
        - Sau khi nhận hàng,&nbsp;Quý khách&nbsp;thanh toán tiền cho nhân viên
        giao hàng&nbsp;số tiền đã xác nhận trước đó&nbsp;với nhân viên của chúng
        tôi với hình thức COD.
      </p>

      <p>
        <strong>2.&nbsp; Chuyển khoản ngân hàng</strong>
      </p>
